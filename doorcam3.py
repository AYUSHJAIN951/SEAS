    ...
    while True:
        ...
        for face_location, face_encoding in zip(face_locations, face_encodings):
            ...
            if metadata is not None:
                ...
                # face_label = f"{metadata['person_name']} is at entry {int(time_at_door.total_seconds())}s"
                face_label = f"{metadata['person_name']} entered entry at {date_time}s"
                ...
                if name != prevname:
                    ...
                    result=db.seasattendancenano.insert_one(attendance)
            ...
            # If this is a brand new face, add it to our list of known faces
                ...
                register_new_face(face_encoding, face_image,g)
                face_label = g
        ...
        for (top, right, bottom, left), face_label in zip(face_locations, face_labels):
            ...
            # Draw a label w    ith a name below the face
        ...
        #         visit_label = f"{metadata['person_name']} - {visits} visits"
        #         if visits == 1:
        #             visit_label = "{metadata['person_name']} - First visit"
